...
{
    public class ScriptableBuildPipelineViewer : BuildPipelineViewerBase
    {
        public ScriptableBuildPipelineViewer(string packageName, BuildTarget buildTarget, VisualElement parent)
            : base(packageName, EBuildPipeline.
                ScriptableBuildPipeline, buildTarget, parent)
        {
        }
        ...
        protected override void ExecuteBuild()
        {
            ...
            YooAssetSettingsData.Setting.Version = GetPackageVersion();
