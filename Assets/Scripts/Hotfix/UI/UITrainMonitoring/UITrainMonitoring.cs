...
namespace Hotfix.UI
{
    public struct UITrainMonitoringData
    {
    ...
    /// 训练监测界面
    /// </summary>
    public class UITrainMonitoring : UIForm<UIViewTrainMonitoring, UIModelTrainMonitoring>
    {
        ...
        private UIViewTrainMonitoring _view;
        private UIModelTrainMonitoring _model;
        ...
        private UITrainMonitoringData _data;
        ...
        public override void OnOpen(object userData)
        {
            ...
            if (userData is UITrainMonitoringData data)
            {
                _data = data;
            }
        ...
        private void OnCheckTipCallHandle(IEventMessage message)
        {
            ...
            else
            {
                ...
                _checkTipItems.UpdateItem(msg.tip, _checkTipCache, _view.tsCheckContent);
                for (var i = 0; i < msg.tip.Count; i++)
                {
                    _checkTipItems.self[i].ShowTip(msg.tip[i]);
                }
