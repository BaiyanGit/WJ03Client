...
public class PortControl : MonoBehaviour
{
    ...
    /// </summary>
    private bool[] _switchs = new bool[32];
    /// <summary>
    /// 薄膜开关
    /// </summary>
    ...
    PortControlSinglechip controlSinglechip;

    private void Awake()
    {
        Instance = this;

        controlSinglechip = new PortControlSinglechip();
    }
    ...
    private void Start()
    {
        ...
        controlSinglechip.InitPort(SensorsComReadManager._coms[5]);
    }
    ...
    {
        PortName = SensorsComReadManager._coms[4];
    ...
    /// 获取第二板开关量
    /// </summary>
    public bool GetAnyKey(int index)
    {
        int indexValue = index - 100;

        if (indexValue >= 0 && indexValue < 32)
        {
            return controlSinglechip._switchs[indexValue];
        }
        return false;
    }
    ...
    private void OnDestroy()
    {
        ...
        if (controlSinglechip._bOpen)
        {
            controlSinglechip.ClosePortControl();
        }
    }
